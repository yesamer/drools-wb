...
public class ScenarioInvokeContextMenuForSelectedCellTest {
    ...
    public void setUp() throws Exception {
        handler = new ScenarioInvokeContextMenuForSelectedCell(gridLayerMock, scenarioContextMenuRegistryMock);
    ...
    public void testMultipleHeaderCells() {
        ...
        Assertions.assertThat(handler.isExecutable(gridWidgetMock))
                .as("Multiple header cells can have one context menu")
                .isTrue();
    }
    ...
    public void testOneHeaderCells() {
        ...
        Assertions.assertThat(handler.isExecutable(gridWidgetMock))
                .as("Single header cell can have one context menu")
                .isTrue();
    }
    ...
    public void testOneDataCell() {
        ...
        Assertions.assertThat(handler.isExecutable(gridWidgetMock))
                .as("Single data cell can have one context menu")
                .isTrue();
    }
    ...
    public void testTwoDataCells() {
        ...
        Assertions.assertThat(handler.isExecutable(gridWidgetMock))
                .as("Multiple data cells can not have one context menu")
                .isFalse();
    }
